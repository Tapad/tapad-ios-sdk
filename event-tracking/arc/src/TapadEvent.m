...
+ (BOOL) send:(NSString *)eventName {
    ...
    TapadEvent* event = [[TapadEvent alloc] initWithName:eventName appId:[TapadPreferences getTapadAppId] extraParams:[TapadPreferences getCustomDataAsSingleEncodedString]];
